                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-primary"><a href="/member/insert">회원 가입 시키기</a></h6>
                        </div>
                        <div class="card-body">
                                ...
                                <table border=2 class="table table-bordered" width="100%" cellspacing="0">
                                    ...
                                    <tbody>
                                    	<c:forEach items="${list}" var="member">
                                    		<tr>
                                    			<td><a href="/member/read?m_id=${member.m_id}&pageNum=${pageview.page.pageNum}">${member.m_id}</a></td>
                                    			<td>${member.m_name}</td>
                                    			<td><fmt:formatDate pattern="yyyy-MM-dd HH-mm-ss" value="${member.m_rdate}" /></td>
                                    		</tr>
                                    	</c:forEach>
                                    	<tr>
