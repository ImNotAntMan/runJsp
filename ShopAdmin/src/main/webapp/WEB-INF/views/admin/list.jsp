                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-primary"><a href="/admin/insert">관리자 생성</a></h6>
                        </div>
                        <div class="card-body">
                                ...
                                <table border=2 class="table table-bordered" width="100%" cellspacing="0">
                                    ...
                                    <tbody>
                                    	<c:forEach items="${list}" var="board">
                                    		<tr>
                                    			<td><a href="/admin/read?a_id=${board.a_id}&pageNum=${pageview.page.pageNum}">${board.a_id}</a></td>
                                    			<td>${board.a_name}</td>
                                    			<td><fmt:formatDate pattern="yyyy-MM-dd HH-mm-ss" value="${board.a_rdate}" /></td>
                                    		</tr>
                                    	</c:forEach>
                                    	<tr>
