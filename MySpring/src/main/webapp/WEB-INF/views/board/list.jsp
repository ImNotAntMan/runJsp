                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-primary"><a href="/board/insert">게시판 글 쓰기</a>${user}&nbsp;${age}세</h6>
                        </div>
                        <div class="card-body">
                                ...
                                <table border=2 class="table table-bordered" width="100%" cellspacing="0">
                                    ...
                                    <tbody>
                                    	<c:forEach items="${list}" var="board">
                                    		<tr>
                                    			<td>${board.b_num}</td>
                                    			<td><a href="/board/read?b_num=${board.b_num}&pageNum=${pageview.page.pageNum}">${board.b_subject}</a></td>
                                    			<td>${board.b_name}</td>
                                    	...
                                    	<tr>
                                    		<td colspan="4" align="center">
                                    			<c:if test="${pageview.prev}">
                                    				<a href="/board/list?pageNum=${pageview.startPage - 1}">[<<]</a>&nbsp;&nbsp;
                                    			...
                                    			<c:if test="${pageview.next}">
                                    				...
                                    				<a href="/board/list?pageNum=${pageview.endPage + 1}">[>>]</a>&nbsp;&nbsp;
                                    			</c:if>                                    			
                                    		</td>
                                    	</tr>
                                    </tbody>
